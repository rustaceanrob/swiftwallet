...
struct SendUnspecifiedInvoiceView: View {
    ...
    init(exchange: Float?, invoice: String?, description: String?) {
                        ...
                        Text("Pay")
                            ...
                            .onTapGesture {
                                    Task {
                                        ...
                                        let _ = await manager.lightningWallet.sendLightningInvoicePayment(fiatAmount: Float(amount)!, paymentType: .lnInvoice, userDescription: self.description)
...
struct SendUnspecifiedInvoiceView_Previews: PreviewProvider {
    static var previews: some View {
        SendUnspecifiedInvoiceView(exchange: nil, invoice: "", description: nil)
